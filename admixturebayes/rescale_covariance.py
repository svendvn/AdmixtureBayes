...
def rescale_empirical_covariance(m, normalizer= ['min', 'max'], outgroup_rate=1):
    '''
    ...
    min_expected_trace=log(n)/log(2)*n+n*outgroup_rate
    max_expected_trace=n*(n+1)/2-1+n*outgroup_rate
