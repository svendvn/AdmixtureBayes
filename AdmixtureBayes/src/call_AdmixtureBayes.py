...
#MCMCMC setup
parser.add_argument('--n', type=int, default=50, help='the number of MCMCMC flips throughout the chain.')
parser.add_argument('--m', type=int, default=2000, help='the number of MCMC steps before the chain is ')
